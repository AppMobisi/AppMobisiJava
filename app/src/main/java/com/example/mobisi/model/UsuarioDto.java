...
public class UsuarioDto {
    ...
    public UsuarioDto( String name, String email, String password, String cpf, String phone, String cep, String city, String neighborhood, String state,  Integer disabilityType) {
        this.name = name;
        this.email = email;
